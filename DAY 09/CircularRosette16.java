...
class CircularRosette16 extends JFrame implements MouseListener {
    Graphics2D g2;

    public CircularRosette16() {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        for (int i = 0; i < petals; i++) {
            ...
            int petalX = (int) (xc + centerDist * Math.cos(angle));
            int petalY = (int) (yc + centerDist * Math.sin(angle));

            drawCircle(petalX, petalY, radiusEach);
        }
    }
